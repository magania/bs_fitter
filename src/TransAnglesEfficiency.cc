...
TransAnglesEfficiency::TransAnglesEfficiency(RooAbsReal* parent, RooRealVar& cpsi, RooRealVar& ctheta, RooRealVar& phi, Efficiency &e) :
    ...
    switch (code) {
        case 1:
            switch (i) {
                ...
                case 3:
                    return 2.6581704104718793e-8 * (693. * _a2 - 11. * (105. + 9. * _a4 + _a6) - 3. * _a8)*(693. * _b2 - 11. * (105. + 9. * _b4 + _b6) - 3. * _b8)* (1757.6169242287651 * _c2 + 315. * (1. + _c4 - 1. * _c6 + _c8) + 19.739208802178716 * (2067.1403090745184 * _c4 + 56156.70369003463 * _c6 + 1.640498235434318e6 * _c8));
                case 4:
                    return 0.005696741357050134 * (693. * _a2 - 11. * (105. + 9. * _a4 + _a6) - 3. * _a8)*(_b1 - 1. * _b3)* (_c1 + 12.478417604357432 * _c3 + 247.87996017365685 * _c5 + 5690.997801077727 * _c7 + 143464.25816772878 * _c9);
                case 5:
                    return 0.0020141022221180026 * (_a1 - 1. * _a3)*(693. * _b2 - 11. * (105. + 9. * _b4 + _b6) - 3. * _b8)*(_c1 + 30.478417604357432 * _c3 + 726.5850164351028 * _c5 + 18430.728116892853 * _c7 + 492529.4992742345 * _c9);
                case 6:
                    return -10.962374249993156 * (_a1 - 1. * _a3)*(_b1 - 1. * _b3)* (_c2 + 26.956835208714864 * _c4 + 784.0751333340436 * _c6 + 23809.424715423258 * _c8);
                default:
