...
public:
    ...
    Double_t cpsi() const {
        return (Double_t) _cpsi;
    }

    Double_t ctheta() const {
        return (Double_t) _ctheta;
    }

    Double_t phi() const {
        return (Double_t) _phi;
    }

    const RooRealProxy& cpsiProxy() const {
        return _cpsi;
    }

    const RooRealProxy& cthetaProxy() const {
        return _ctheta;
    }

    const RooRealProxy& phiProxy() const {
        return _phi;
    }

    void cpsi(Double_t cpsi) {
        _cpsi = cpsi;
    }

    void ctheta(Double_t ctheta) {
        _ctheta = ctheta;
    }

    void phi(Double_t phi) {
        _phi = phi;
    }
    ...
    Double_t int_f(Int_t i, Int_t code, const char* range) const;
    
    virtual Double_t fe(Int_t i) const{};
    virtual Double_t int_fe(Int_t i, Int_t code, const char* range) const{};
